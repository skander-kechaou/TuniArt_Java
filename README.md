...
- [IntelliJ IDEA](https://www.jetbrains.com/idea/) (or another Java IDE) - for the Java application
- [SceneBuilder](https://gluonhq.com/products/scene-builder/) - for designing JavaFX GUIs
- Java 11 or higher (for Java-based app)
